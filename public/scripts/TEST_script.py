...
if json_path is None:
    forms.alert(
        ...
        "  • OneDrive\n\n"
        "Descarrega'l des de la plataforma TaulaMaster CBT-BIM.".format(JSON_FILENAME),
        exitscript=True
    )
...
res = forms.alert(
    ...
    "Plantilles: {}\n"
    "Sortida: {}\n\n"
    "Continuar?".format(len(test_equips), cat_lines, json_path, templates_folder, output_folder),
    ok=True, cancel=True
)
if not res:
    script.exit()
